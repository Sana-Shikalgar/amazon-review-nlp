...
> `05_visualisations.ipynb` detects this and falls back to a **median split** on `helpful_vote`
...
*Exact figures printed in `05_visualisations.ipynb` Cell 3 output — re-run to refresh.*
